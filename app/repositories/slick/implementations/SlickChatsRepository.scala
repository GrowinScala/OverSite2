...
/*** Get Chat by ID ***/
  ...
  /**
   * Method that retrieves the email of a specific chat that a user can see:
  ...
  private def getEmailsQuery(chatId: Int, userId: Int) = {
    ...
    // All chat metadata, including the emails
