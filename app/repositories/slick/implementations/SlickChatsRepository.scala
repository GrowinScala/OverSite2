...
class SlickChatsRepository @Inject() (db: Database)(implicit executionContext: ExecutionContext)
  ...
  private def groupEmailsAndAddresses(
    ...
    emailAddressesQuery: Query[(Rep[String], Rep[String], Rep[String]), (String, String, String), scala.Seq]): Future[(Seq[String], scala.Seq[Email])] = {
   ...
   */
  private def getGroupedEmailsAndAddresses(chatId: String, userId: String): Future[(Seq[String], Seq[Email])] = {
